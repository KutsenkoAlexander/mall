...
/**
 * Redis Аспекты кеширования, чтобы время простоя Redis не влияло на нормальную бизнес-логику
...
public class RedisCacheAspect {
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            //Аннотированные методы CacheException должны генерировать исключения
